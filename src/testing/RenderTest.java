...
public class RenderTest {
    ...
    public void basicRendering(){
       ...
       // scene= new Scene("point&vector change",Color.BLACK,
        ...
        ImageWriter imageWriter = new ImageWriter(scene.getSceneName()+ " 000", 500, 500, 500, 500);
    ...
    public void basicRendering2(){
        ...
        ImageWriter imageWriter = new ImageWriter(scene.getSceneName()+ " 111", 100, 100, 500, 500);
